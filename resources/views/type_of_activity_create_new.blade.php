        ...
        <form method="post" action={{url('type_of_activity')}}>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('activity_name') is-invalid @enderror"
                    id="type_of_activity_name" name="type_of_activity_name" aria-describedby="type_of_activity_nameHelp" value={{old('type_of_activity_name')}}>
                <div id="type_of_activity_nameHelp" class="form-text">*Введите название вида активности</div>
