...
class Type_of_activityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/types_of_activity')->withErrors([
            'success' => 'Вы создали вид активности: '. $request->type_of_activity_name
        ]);
    }
    ...
    {
        $validated = $request->validate([
            'type_of_activity_name' => 'unique:types_of_activity|max:255',
            'maximum_score' => 'required|integer',
            'user_id' => 'integer'
        ]);
        $type_of_activity = Type_of_activity::all()->where('id', $id)->first();
        $type_of_activity->type_of_activity_name = $validated['type_of_activity_name'];
    ...
    public function destroy(string $id)
    {
        ...
        return back()->withErrors([
            'success' => 'Вы удалили вид активности: '. $type_of_activity->type_of_activity_name
        ]);
    }
}
